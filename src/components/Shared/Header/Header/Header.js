                                    ...
                                    <div className="a">
                                        ...
                                        <div className="offcanvas offcanvas-end text-dark" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
                                            ...
                                            <div className="offcanvas-body">
                                                <div className="a">
                                                    <Link to="/dashboard/myorders" className="fs-5 border py-1 d-inline-block mb-3 profile-menu-box">
                                                        <i className="fas fa-laptop-house"></i><p className="m-0">My Orders</p>
                                                    </Link> <br />
