                    ...
                    <div className="">
                        <div className="a">
                            <form onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <div className="a">
                                    <button className="shops-btn w-100">Log in</button>
                                </div>
                                <button className="btn border fs-5 w-100 mt-4" onClick={handelgoogleSingin}><i className="fab fa-google-plus-g"></i> Log In with Google</button>
                            </form>
